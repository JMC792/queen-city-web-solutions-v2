    ...
    const posts = Object.values(blogData).map((post, index) => ({
        id: post.slug,
        title: post.name,
        href: post.slug,
        description: post.sentence,
        imageUrl: postImages[index % postImages.length],
        date: post.date,
        datetime: post.datetime,
        author: {
            name: post.author || "Queen City Web Solutions",
            imageUrl:
    ...
    <div className="bg-white py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-2xl text-center">
            ...
            Practical security notes for business owners who want to stay ahead of active threats.
            </p>
        </div>
